...
public class ImageViewerView extends RelativeLayout
    ...
    private OnTouchUpDownEventListener upDownEventListener;

    public interface OnTouchUpDownEventListener {
        void onImageViewerTouchUp();
        void onImageViewerTouchDown();
    }
    ...
    private void onActionDown(MotionEvent event) {
        ...
        if (null != upDownEventListener)
            upDownEventListener.onImageViewerTouchDown();
    }
    ...
    private void onActionUp(MotionEvent event) {
        ...
        if (null != upDownEventListener)
            upDownEventListener.onImageViewerTouchUp();
    }
    ...
    public void setUpDownEventListener(OnTouchUpDownEventListener upDownEventListener) {
        this.upDownEventListener = upDownEventListener;
    }

    public void setOverlayViewVisibility(int visibility) {
        if (null != overlayView)
